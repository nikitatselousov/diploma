...
public class FindClosestTimeInFuture extends EvalFunc<Tuple> {
    private static final Logger LOG = Logger.getLogger(FindClosestTimeInFuture.class.getName());
    ...
    private enum OutputTuple {
        Tate,Accident_Index,Longitude,Latitude,Time,Weather_Conditions,Road_Surface_Conditions,w_src,dist,DATE, TIME,SRC_ID, PRST_WX_ID,PAST_WX_ID_1,PAST_WX_ID_2;
            ...
            if (i instanceof  DataBag){
                ...
                try {
                    ...
                    while (iter.hasNext()){
                        ...
                        if (min.getTime() - accTime.getTime() > tupleTime.getTime() - accTime.getTime() && accTime.getTime() - tupleTime.getTime() < 0){
                            min = tupleTime;
                            output = kek;
                        }
                    }
    ...
    public Schema tupleSchema(Schema schema) throws Exception {
        ...
        for (int i = 0; i < kekus.length; i++){
            ...
            else if (kekus[i].equalsIgnoreCase("SRC_ID")|| kekus[i].equalsIgnoreCase("PAST_WX_ID_2")|| kekus[i].equalsIgnoreCase("PAST_WX_ID_1")|| kekus[i].equalsIgnoreCase("PRST_WX_ID")|| kekus[i].equalsIgnoreCase("Weather_Conditions") || kekus[i].equalsIgnoreCase("Road_Surface_Conditions"))
