 ...
 */
public class WeatherProcTrafFlow {
    ...
    public static void mane() throws Exception{
        ...
        PrintWriter writer = new PrintWriter("/media/762486602486236B__/diploma/fullflow.csv", "UTF-8");
        ...
        for (CSVRecord csvRecord : collParser){
            ...
            Double collLong = Double.parseDouble(csvRecord.get(10));
            Double collLat = Double.parseDouble(csvRecord.get(9));
